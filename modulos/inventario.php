        ...
        <main class="p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div class="flex space-x-2 overflow-x-auto pb-2 md:pb-0 flex-shrink-0">
                    ...
                    <a href="inventario.php?<?= $buscar_termino ? 'buscar=' . htmlspecialchars($buscar_termino) . '&' : '' ?>tipo=produccion" class="px-3 py-1 rounded-full transition-colors duration-200 <?= ($tipo_filtro === 'produccion') ? 'bg-blue-600 text-white' : 'border border-blue-500 text-blue-700 hover:bg-blue-50' ?>">Producción</a>
                                ...
                                <?php foreach ($productos as $producto): ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?= htmlspecialchars($producto['nombre']) ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php
                                            $badgeClasses = [
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900 dark:text-white"><?= htmlspecialchars($producto['cantidad']) ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900 dark:text-white">$<?= number_format($producto['precio'], 2) ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400"><?= htmlspecialchars($producto['fecha_ingreso']) ?></div>
                                        </td>
